...
export class Product extends BaseEntity {
  ...
  @Column({ name: 'category_id', type: 'bigint', nullable: true, comment: '商品分类 ID' })
  ...
  @Column({ name: 'product_model', type: 'varchar', length: 100, comment: '产品型号' })
  productModel: string

  @Column({ name: 'image_url', type: 'varchar', length: 500, nullable: true, comment: '商品图片' })
